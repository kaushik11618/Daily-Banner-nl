      ...
      const PostDetails = async (e) => {
        try {
          const response = await fetch(
            `http://192.168.29.12:3000/api/post/${editPostId}`,
            {
              method: "GET",
              headers: {
          ...
          setSelectedSubcategory(data.sub_category.name);
          ...
          setSelectedPostDate(data.posting_date);
          setSelectedDueDate(data.ending_date);
          setWhatsapp(data.post_platform.includes("whatsapp"));
          setFacebook(data.post_platform.includes("facebook"));
          setInstagram(data.post_platform.includes("instagram"));
          setLinkedIn(data.post_platform.includes("linkedIn"));
          setTwitter(data.post_platform.includes("twitter"));
        } catch (e) {}
      };
      PostDetails();
    } else {
